        ...
        switch (estadoDeJuego)
        {
            ...
            case JUGANDO:
                ...
                while (estadoDeJuego == JUGANDO)
                    estadoDeJuego = interfazJuego(resolAncho, resolAlto, tetroActivos, &grillaDeFondo, &tempCaida, &tempInactiv, &velActual, &modoVelocidad, modoDeluxe,cheatsActivos);
                break;
            ...
            case PAUSA:
                ...
                botonCrear(&botonesMenuPausa[3], INACTIVO, ANCHO_BOTON_GRANDE, ALTO_BOTON_DEFAULT, (resolAncho - ANCHO_BOTON_GRANDE)/2, baseYP + 3*pasoP, B, R,"CHEATS",N);
                ...
                while (estadoDeJuego == PAUSA)
                    estadoDeJuego = menuPausa(resolAncho, resolAlto, &cursorBoton, botonesMenuPausa, 5, &cheatsActivos);
