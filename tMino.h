...
void tetrominoCargarVector(tTetromino vec[TAM_VEC_TETROMINOS], int totalTetrominos, int anchoGrilla);         //Toma un vector de un tamaño TAM_VEC_TETROMINOS y lo carga con tetrominos al azar
